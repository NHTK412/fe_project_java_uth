...
const WarehouseReceiptFilter = ({
  ...
  const sortOptions = [
    ...
    { value: "warehouseReceiptDate", label: "Ngày nhập" },
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 mb-6">
      ...
      <div className="relative flex-1 min-w-[250px] max-w-md">
        ...
        <input
          type="text"
          placeholder="Tìm kiếm theo ID, đại lý, ngày nhập..."
          value={searchTerm}
...
export default WarehouseReceiptFilter;
