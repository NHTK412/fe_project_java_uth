...
const ImportRequestDetail = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">
                        Chi tiết đơn đặt xe #{detail.importRequestId}
                    </h1>
                </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 mt-1">#{detail.agencyId || "-"}</p>
                    </div>
            ...
            {detail.importRequestDetails && detail.importRequestDetails.length > 0 && (
                <div className="bg-white rounded-lg p-6 border border-gray-200 space-y-4">
                    <h2 className="text-xl font-semibold text-gray-900">
                        Chi tiết sản phẩm ({detail.importRequestDetails.length})
                    </h2>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            ...
                            <tbody>
                                {detail.importRequestDetails.map((item, index) => (
                                    <tr
                                        key={index}
                    ...
                    <div className="pt-4 border-t border-gray-200">
                        <p className="text-sm text-gray-600">
                            ...
                            {detail.importRequestDetails.reduce((sum, item) => sum + item.quantity, 0)}{" "}
                            chiếc
                        </p>
                    </div>
                </div>
