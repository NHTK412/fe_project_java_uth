...
import { getOrdersByEmployeeId } from "../../services/api/orderService";

const DealerStaffEmployeeOrderList = () => {
    ...
    // NOTE: Gọi API để lấy danh sách các đơn hàng của nhân viên
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                setLoading(true);
                setError(null);
                const data = await getOrdersByEmployeeId(page, size);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    onClick={() => navigate("/dealerStaff/order/create")}
            ...
            <div className="relative">
                ...
                <input
                    type="text"
                    placeholder="Tìm kiếm theo khách hàng, số hợp đồng hoặc ghi chú..."
                    value={searchTerm}
                                ...
                                filteredOrders.map((order) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-xs whitespace-nowrap">
                                            <button
                                                onClick={() =>
                                                    navigate(`/dealerStaff/order/${order.orderId}`)
                                                }
...
export default DealerStaffEmployeeOrderList;
